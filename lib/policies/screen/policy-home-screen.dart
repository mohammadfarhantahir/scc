...
import '../widget/listview-detailed.dart';

class PolicyHomeScreen extends StatefulWidget{
  State<PolicyHomeScreen> createState()=> PolicyHomeScreenState();
}

class PolicyHomeScreenState extends State<PolicyHomeScreen>{
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            CachedNetworkImage(
                              imageUrl: "https://raptorassistant.com/shaw-charity-classic/assets/ShawCharityClassic_Header_Policies%403x.png",
                    ...
                    Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('Welcome to the Shaw Charity Classic Presented by Rogers!',
                              style: TextStyle(
                                fontFamily: 'ShawBold',
                                color: Colors.black,
                                fontSize: 18,
                            ...
                            SizedBox(height: 20,),
                            Text('The following details the health and safety measures that you can expect during your visit. If you do not agree to these policies and terms, please do not enter the grounds. Thank you for joining us and we hope you enjoy your time at the Shaw Charity Classic!',
                              style: TextStyle(
                            ...
                            Container(
                              ...
                              child: ExpandableCardsColumnPolicies(),
                            )
                          ],
                        )
                    ),
