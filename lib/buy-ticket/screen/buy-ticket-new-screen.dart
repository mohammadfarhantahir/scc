...
class BuynewTicketScreen extends StatefulWidget{
  State<BuynewTicketScreen> createState()=> BuynewTicketScreenState();
}

class BuynewTicketScreenState extends State<BuynewTicketScreen>{
  ...
  void _launchHospital() async {
    const facebookUrl = 'https://shawcharityclassic.com/wp-content/uploads/2023/05/2023-SCC-Hospitality-Opportunities.pdf'; // Replace with your Facebook profile URL
    if (await canLaunch(facebookUrl)) {
      await launch(facebookUrl);
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            CachedNetworkImage(
                              imageUrl: "https://raptorassistant.com/shaw-charity-classic/assets/Shaw_Charity_Classic_Spectator_Info_2_header%403x.png",
